...
function AdminPanel() {
  ...
  const handleSendCodeToEmail = async (
    ...
    try {
      const authtoken = localStorage.getItem("authtoken");
      const response = await fetch('http://localhost:8001/api/admin/sendcodetoemail', {
        method: "POST",
        headers: {
  ...
  const handleRegister = async () => {
    try {
      const response = await fetch('http://localhost:8001/api/admin/createorg', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authtoken: `${authtoken}`,
  ...
  const getAllOrganization = async () => {
    try {
      const authtoken = localStorage.getItem("authtoken");
      const response = await fetch('http://localhost:8001/api/admin/getallorgs', {
        method: "GET",
        headers: {
          "Content-type": "application/json",
          authtoken: `${authtoken}`,
